...
# import sqlite3
# import json #request.get_json() would be better for JSON data handling
# app = Flask(__name__)
...
#     query = f"SELECT * FROM users WHERE id = '{user_id}'" #possible SQL injection vulnerability
#     cursor.execute(query)
#     user = cursor.fetchone()
    
#     if user:
#         return str(user) # JSON response would be better
#     else:
